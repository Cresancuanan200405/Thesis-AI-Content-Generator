...
/**
* @see \App\Http\Controllers\ProductController::bulkDestroy
 * @see app/Http/Controllers/ProductController.php:189
 ...
 * @see app/Http/Controllers/ProductController.php:168
 * @route '/products/{product}'
 */
...
const ProductController = { index, create, store, bulkDestroy, show, edit, update, destroy }
