 ...
 * @see app/Http/Controllers/EventController.php:214
...
/**
* @see \App\Http\Controllers\EventController::manage
 * @see app/Http/Controllers/EventController.php:309
 * @route '/events'
 */
 ...
 * @see app/Http/Controllers/EventController.php:390
 * @route '/events'
 */
 ...
 * @see app/Http/Controllers/EventController.php:532
 * @route '/events/{event}'
 */
 ...
 * @see app/Http/Controllers/EventController.php:558
 * @route '/events/{event}'
 */
 ...
 * @see app/Http/Controllers/EventController.php:581
 * @route '/events/{event}'
 */
...
const EventController = { index, getYearEvents, manage, store, show, update, destroy }
