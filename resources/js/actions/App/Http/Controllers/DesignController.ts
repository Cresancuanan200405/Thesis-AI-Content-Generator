 ...
 * @see app/Http/Controllers/DesignController.php:211
 * @route '/designs'
 */
...
const DesignController = { index, store, bulkDestroy, show, toggleFavorite, finalize, attachCampaign, download, regenerate, destroy }
