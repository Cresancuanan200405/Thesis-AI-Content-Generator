            ...
            <div className="mx-auto grid min-h-[calc(100vh-2rem)] max-w-6xl overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 shadow-[0_30px_90px_rgba(15,23,42,0.75)] backdrop-blur-xl lg:grid-cols-[0.95fr_1.05fr]">
                <div className="relative hidden overflow-hidden bg-slate-950/80 p-8 text-white lg:flex lg:flex-col lg:justify-between">
                    ...
                    <div className="relative z-10 flex items-center gap-3">
                        ...
                        <span className="text-sm font-semibold tracking-[0.28em] text-slate-200 uppercase">
                            MarketPilot
                        </span>
                    </div>

                    <div className="relative z-10 space-y-6">
                        <div className="inline-flex items-center rounded-full border border-blue-400/30 bg-blue-500/10 px-3 py-1 text-xs font-medium tracking-[0.2em] text-blue-100 uppercase">
                            AI marketing OS
                        </div>
                        <h1 className="max-w-sm text-4xl leading-tight font-semibold text-white">
