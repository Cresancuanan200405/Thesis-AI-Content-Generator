...
const steps: StepConfig[] = [
    ...
    { title: 'Brand Identity', subtitle: 'Define your visual direction' },
    {
        ...
        subtitle: 'Tune the type of content you want',
    },
...
export default function OnboardingIndex({ step = 1, business, brand }: Props) {
    ...
    const [preferencesForm, setPreferencesForm] = useState<PreferencesForm>({
        target_audience: (business as any)?.target_audience ?? '',
        unique_selling_point: (business as any)?.unique_selling_point ?? '',
        content_style: (business as any)?.content_style ?? [],
        default_tagline_behavior:
            (business as any)?.default_tagline_behavior ?? '',
    });
            ...
            <div className="flex gap-1 overflow-x-auto pb-1 md:hidden">
                {steps.map((stepItem, index) => (
                    <div
                        key={stepItem.title}
                        className={cn(
                            'rounded-full border px-2 py-1 text-[10px] tracking-wide uppercase',
                            currentStep === index + 1
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
                <h1 className="text-3xl font-semibold tracking-tight">
                    Welcome to AI Marketing Automation
                </h1>
                <p className="text-base text-muted-foreground">
                    Let&apos;s set up your business so we can create marketing
                    content that fits your brand.
                </p>
                <p className="text-sm text-muted-foreground">
                    This setup only takes a few minutes and helps us tailor
            ...
            <div className="grid gap-5">
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        placeholder="Coffee Shop, SaaS Agency, Dental Clinic"
                    />
                    {errors?.category && (
                        <p className="text-sm text-destructive">
                            {errors.category}
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        ...
                        placeholder="Tell us what your business does, who you serve, and what makes it unique."
                        rows={5}
                    />
                    {errors?.description && (
                        <p className="text-sm text-destructive">
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="mt-2 text-muted-foreground">
                    Your brand settings help keep generated marketing designs
                    visually consistent.
                </p>
            </div>
            ...
            <div className="grid gap-5 md:grid-cols-2">
                ...
                <div className="space-y-2">
                    ...
                    <Select
                        ...
                        onValueChange={(value) =>
                            setBrandForm({ ...brandForm, typography: value })
                        }
                    >
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    ...
                                    isSelected
                                        ? 'border-primary bg-primary text-primary-foreground'
                                        : 'border-muted bg-transparent text-muted-foreground hover:bg-muted',
                                )}
                            >
                                {tone}
                            </button>
            ...
            <div className="space-y-2">
                ...
                <Textarea
                    id="brand_guidelines"
                    value={brandForm.brand_guidelines}
                    onChange={(e) =>
                        setBrandForm({
                            ...brandForm,
                    ...
                    placeholder="Describe any important rules your marketing designs should follow."
                    rows={4}
                />
            </div>
            ...
            <div className="space-y-2">
                ...
                <Textarea
                    ...
                    value={brandForm.visual_preferences}
                    onChange={(e) =>
                        setBrandForm({
                            ...brandForm,
                            visual_preferences: e.target.value,
                        })
                    }
                    placeholder="Describe the visual style you prefer for your marketing images."
                    rows={4}
                />
            </div>
        </div>
        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-5">
                <div className="space-y-2">
                    ...
                    <Textarea
                        id="target_audience"
                        value={preferencesForm.target_audience}
                        onChange={(e) =>
                            setPreferencesForm({
                                ...preferencesForm,
                        ...
                        placeholder="Young professionals aged 25–40 who enjoy premium coffee."
                        rows={3}
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        ...
                        value={preferencesForm.unique_selling_point}
                        onChange={(e) =>
                            setPreferencesForm({
                                ...preferencesForm,
                                unique_selling_point: e.target.value,
                            })
                        }
                        placeholder="We use locally sourced beans and roast them in small batches."
                        rows={3}
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {contentStyleOptions.map((option) => {
                            const selected =
                                preferencesForm.content_style.includes(option);
                            ...
                            return (
                                <button
                                    ...
                                    onClick={() =>
                                        setPreferencesForm({
                                            ...preferencesForm,
                                            content_style: toggleItem(
                                                preferencesForm.content_style,
                                                option,
                                            ),
                                        })
                                    }
                        ...
                        {taglineOptions.map((option) => (
                            <button
                                ...
                                onClick={() =>
                                    setPreferencesForm({
                                        ...preferencesForm,
                                        default_tagline_behavior: option,
                                    })
                                }
                                className={cn(
                                    'rounded-md border p-3 text-left text-sm transition',
                                    preferencesForm.default_tagline_behavior ===
                                        option
                                        ? 'border-primary bg-primary/10 text-primary'
                                        : 'border-muted bg-transparent text-muted-foreground hover:bg-muted',
                                )}
        ...
        <div className="space-y-6 text-center">
            ...
            <div>
                ...
                <p className="mt-3 text-muted-foreground">
                    Your business profile is ready. Let&apos;s start creating
                    marketing content.
                </p>
            </div>
            <div className="grid gap-3 rounded-xl border bg-muted/30 p-4 text-left md:grid-cols-3">
                ...
                <div>
                    ...
                    <p className="mt-2 font-medium">
                        {brandForm.typography || 'Brand identity set'}
                    </p>
                </div>
                <div>
                    <p className="text-xs tracking-wide text-muted-foreground uppercase">
                    ...
                    <p className="mt-2 font-medium">
                        {preferencesForm.content_style.length
                            ? preferencesForm.content_style.join(', ')
                            : 'Customizable'}
                    </p>
                </div>
            </div>
