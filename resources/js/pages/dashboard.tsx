    ...
    const summaryCards = [
        {
            ...
            note: 'Campaigns in your workspace',
        },
        {
            ...
            note: 'Currently driving work',
        },
        {
            label: 'Upcoming Events',
            value: String(upcoming_events.length ?? 0),
            note: 'Events on your timeline',
        },
        {
            ...
            <div className="space-y-6 p-4 md:p-6">
                ...
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    {summaryCards.map((card) => (
                        <Card
                            key={card.label}
                            className="border-border/80 bg-card/75 text-card-foreground shadow-[0_16px_50px_rgba(15,23,42,0.06)] backdrop-blur-xl"
                        >
                        ...
                        <CardContent className="space-y-4">
                            {upcoming_events.length === 0 ? (
                                ...
                                upcoming_events.map((event: any) => (
                                    <div
                                        key={event.name}
                                        className="flex items-center justify-between rounded-xl border border-border bg-muted/25 p-4"
                                    >
                                        <div>
                                        ...
                                        <Button
                                            ...
                                            size="sm"
                                            asChild
                                            className="bg-background/40 hover:bg-accent/60"
                                        >
                                            <Link href="/generator">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="pt-2">
                                <Button
                                    asChild
                                    variant="outline"
                                    className="w-full bg-background/40 hover:bg-accent/60"
                                >
                                    <Link href="/designs">
                                        View All Designs
                                    </Link>
